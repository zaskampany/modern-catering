...
export const map = {
  // Only a real embed URL is trusted; anything else would render a Google
  // "refused to connect" frame, so we quietly use the query form instead.
  embedUrl: /^https:\/\/(www\.)?google\.[^/]+\/maps\/embed/.test(embedFromEnv)
    ? embedFromEnv
